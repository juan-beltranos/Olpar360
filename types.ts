...
export const IBAGUE_DATA: Record<string, string[]> = {
    ...
    "Comuna 5": ["Jordán 1-3 Etapa", "Jordán 4,6,7,8,9 Etapa", "La Campiña", "Prados del Norte", "Rincón de Piedra Pintada", "Arkacentro", "Sorrento", "Versalles", "Hacienda Piedra Pintada"],
